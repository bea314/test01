...
import { PlusCircle, ArrowLeft, ListFilter, PercentSquare } from "lucide-react";
...
export default function AddDiscountPage() {
  ...
  const handleSaveDiscount = () => {
    ...
    mockPresetDiscounts.push(newDiscount);
    ...
    <div className="container mx-auto py-8">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-headline font-bold text-foreground flex items-center">
          <PercentSquare className="mr-2 h-7 w-7 text-primary" />Add New Preset Discount
        </h1>
      ...
      <Card className="max-w-2xl mx-auto shadow-xl">
        <CardHeader>
          ...
          <CardDescription>Create a new preset discount for quick application to orders.</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-6">
            ...
            <div className="col-span-4 mt-2">
              ...
              <p className="text-sm text-muted-foreground mb-3">If no items or categories are selected, the discount applies to the entire order subtotal (excluding already courtesied items).</p>
            </div>
